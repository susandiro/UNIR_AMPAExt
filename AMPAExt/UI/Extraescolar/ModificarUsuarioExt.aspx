<%@ Page Title="Alta de usuario AMPA" Language="C#" MasterPageFile="~/Master/SiteExtraescolar.Master" AutoEventWireup="true" CodeBehind="ModificarUsuarioExt.aspx.cs" Inherits="AMPAExt.UI.Extraescolar.ModificarUsuarioExt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="content_midd">
        <form id="form1" runat="server">
            <h1 class="tituloCentral">Modificar usuario de empresa extraescolar</h1>
            ...
            <div class="espacioleft">
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <asp:DropDownList ID="cmbTipoDocumento" DataTextField="NOMBRE" DataValueField="ID_TIPO_DOCUMENTO" runat="server" Enabled="false" ToolTip="Seleccione el tipo de documento del usuario" CssClass="txtObligatorio" />                        
                    </div>
                    <div class="col-md-2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <asp:TextBox ID="txtNumDocumento" ToolTip="Número de documento del usuario" runat="server" Enabled="false" CssClass="txtObligatorio"></asp:TextBox>
                    </div>
                    <div class="col-md-2">
                ...
                <div class="row espaciosupBoton">
                    <div class="col-md-2">
                        <asp:Button ID="BtnModificar" CssClass="boton " runat="server" ToolTip="Modificar usuario" OnClick="BtnModificar_Click" Text="Modificar" />
                    </div>
                    <div class="col-md-10">
