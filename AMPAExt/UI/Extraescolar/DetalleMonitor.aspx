<%@ Page Title="Alta de usuario AMPA" Language="C#" MasterPageFile="~/Master/SiteExtraescolar.Master" AutoEventWireup="true" CodeBehind="DetalleMonitor.aspx.cs" Inherits="AMPAExt.UI.Extraescolar.DetalleMonitor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="content_midd">
        <form id="form1" runat="server">
            <h1 class="tituloCentral">Consulta de monitor de empresa extraescolar</h1>
            ...
            <div class="espacioleft">
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <asp:TextBox ID="txtTelefono" TextMode="Phone" ToolTip="Teléfono del usuario" runat="server" Enabled="false"></asp:TextBox>
                    </div>
                     <div class="col-md-2"></div>
                </div>
                <div class="row">
