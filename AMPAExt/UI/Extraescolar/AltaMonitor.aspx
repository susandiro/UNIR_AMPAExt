<%@ Page Title="Alta de usuario AMPA" Language="C#" MasterPageFile="~/Master/SiteExtraescolar.Master" AutoEventWireup="true" CodeBehind="AltaMonitor.aspx.cs" Inherits="AMPAExt.UI.Extraescolar.AltaMonitor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="content_midd">
        <form id="form1" runat="server">
            <h1 class="tituloCentral">Nuevo monitor para la empresa extraescolar</h1>
            ...
            <div class="espacioleft">
                ...
                <div class="row espaciosupBoton">
                    <div class="col-md-2">
                        <asp:Button ID="btnAceptar" CssClass="boton " runat="server" ToolTip="Da de alta un nuevo monitor para la empresa" OnClick="BtnAceptar_Click" Text="Aceptar" />
                    </div>
                     <div class="col-md-3">
