<%@ Page Title="Alta de usuario AMPA" Language="C#" MasterPageFile="~/Master/SiteAdministracion.Master" AutoEventWireup="true" CodeBehind="AltaUsuario.aspx.cs" Inherits="AMPAExt.UI.Administracion.AltaUsuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="content_midd">
        <form id="form1" runat="server">
            <h1 class="tituloCentral">Nuevo usuario de AMPA</h1>
            ...
            <div class="espacioleft">
                ...
                <div class="row espaciosupBoton">
                    <div class="col-md-12">
                        <asp:Button ID="btnAceptar" CssClass="boton " runat="server" ToolTip="Da de alta al nuevo usuario para la AMPA" OnClick="BtnAceptar_Click" Text="Aceptar" />
                    </div>
                </div>
            </div>
        </form>
