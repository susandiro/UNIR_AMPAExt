<%@ Page Title="Alta de usuario AMPA" Language="C#" MasterPageFile="~/Master/SiteAdministracion.Master" AutoEventWireup="true" CodeBehind="ModificarUsuario.aspx.cs" Inherits="AMPAExt.UI.Administracion.ModificarUsuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="content_midd">
        <form id="form1" runat="server">
            <h1 class="tituloCentral">Modificar usuario de AMPA</h1>
            ...
            <div class="espacioleft">
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <asp:TextBox ID="txtNumDocumento" Enabled="false" ToolTip="Número de documento del usuario" runat="server" CssClass="txtObligatorio"></asp:TextBox>
                    </div>
                    <div class="col-md-2">
                ...
                <div class="row espaciosupBoton">
                    <div class="col-md-2">
                        <asp:Button ID="BtnModificar" CssClass="boton " runat="server" ToolTip="Modificar usuario de AMPA" OnClick="BtnModificar_Click" Text="Modificar" />
                    </div>
                    <div class="col-md-10">
