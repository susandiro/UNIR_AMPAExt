<%@ Page Title="Alta de usuario AMPA" Language="C#" MasterPageFile="~/Master/SiteAdministracion.Master" AutoEventWireup="true" CodeBehind="DetalleUsuario.aspx.cs" Inherits="AMPAExt.UI.Administracion.DetalleUsuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="content_midd">
        <form id="form1" runat="server">
            <h1 class="tituloCentral">Consulta de usuario de AMPA</h1>
