...
{
    /// <summary>
    /// Funcionalidad para modificar un socio de AMPA
    /// </summary>
    public partial class ModificarSocio : PageBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Se realiza una validación previa sobre el formulario y en caso de que sea correcto, se modifica en base de datos
        /// </summary>
        protected void BtnModificar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    TUTOR tutor = NegSocio.GetSocioById(IdSocio, MasterBase.DatosSesionLogin.IdEmpresa);
                    ...
                    if (NegSocio.ModificarSocio(tutor, actAlumnos))
                    {
                        VaciarFormulario(this);
                        Session["listadoAlumnos"] = null;
                        PanelInfo.MostrarMensaje(Comun.TipoDatos.TipoError.Success, "El socio se ha sido modificado correctamente.");
                    }
                    else
                        PanelInfo.MostrarMensaje(Comun.TipoDatos.TipoError.Error, "Se ha producido un error al modificar los datos del socio en la AMPA");
                }
                else
            ...
            {
                Comun.Log.TrazaLog.Error("Error al modificar el socio.", ex);
                PanelInfo.MostrarMensaje(Comun.TipoDatos.TipoError.Error, "Se ha producido un error al modificar los datos del socio en la AMPA");
            }
        }
        ...
        private void CargarDatos()
        {
            ...
            if (datosTutor != null)
            {
                ...
                cmbTipoDocumento1.SelectedValue = datosTutor.T1_ID_TIPO_DOCUMENTO.ToString();
                ...
                cmbTipoDocumento2.SelectedValue = datosTutor.T2_ID_TIPO_DOCUMENTO.ToString();
