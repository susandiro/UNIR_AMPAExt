<%@ Page Title="Alta de empresa extraescolar" Language="C#" MasterPageFile="~/Master/SiteSocio.Master" AutoEventWireup="true" CodeBehind="ModificarSocio.aspx.cs" Inherits="AMPAExt.UI.Socio.ModificarSocio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="content_midd">
        <form id="form1" runat="server">
            ...
            <h1 class="tituloCentral">Modificar socio de AMPA con número de socio <asp:Label ID="lblNumSocio" runat="server" ToolTip="Número de socio"></asp:Label></h1>
...
<ContentTemplate>
                ...
                <div class="row">
                  ...
                  <div class="row espaciosupBoton">
                    <div class="col-md-2">
                        <asp:Button ID="BtnModificar" CssClass="boton " runat="server" ToolTip="Modificar el socio de AMPA" OnClick="BtnModificar_Click" Text="Modificar" />
                    </div>
                    <div class="col-md-10">
